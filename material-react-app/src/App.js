    ...
    <>
      {/*isDemo && (
        <MetaTags>
          <meta
            name="keywords"
            content= "A sports management website"
          />
          <meta
            name="description"
            content="A sports event management website"
          />
          <meta
            itemProp="name"
            content="KCPD"
...
admin/documents?user_type=player
          ...
          <meta
            name="twitter:title"
            content="KCPD twitter"
          />
          <meta
            name="twitter:description"
            content="A sports management website"
          />
          <meta name="twitter:creator" content="@KCPD" />
          <meta
            name="twitter:image"
            content=""
          />
          ...
          <meta
            ...
            content="A free full stack app powered by MUI component library, React and Node.js API, featuring dozens of handcrafted UI elements"
          />
          <meta property="og:site_name" content="KCPD Group" />
        </MetaTags>
      )
