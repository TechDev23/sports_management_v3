  ...
  return (
    ...
    <div className=' flex flex-col justify-center items-center space-y-10'>
        ...
        <div className='flex flex-col items-center space-y-3'>
            <p className='text-2xl sm:text-2xl md:text-3xl lg:text-4xl  text-center font-bold mt-5 sm:mt-10'>Verify your atleast 1 document(s) to proceed </p>
            <p className='text-xs sm:text-sm text-center text-gray-500'>PDF, text, images or videos. Max 10MB each</p>
        </div>
    ...
    <div className='w-full h-52  rounded-xl flex flex-col justify-center items-center space-y-2'>
        ...
        <div
          ...
          className={`py-10 border-2 rounded-lg w-3/4 sm:w-2/4 md:w-1/3 lg:w-1/4 h-full flex flex-col items-center justify-center space-y-2 border-dashed bg-blue-gray-50 ${allow ? '' : 'cursor-not-allowed opacity-50'} ${
                ...
                <div className='w-full   flex flex-col items-center justify-center p-5  text-gray-500'>
                 {
                  ...
                  <div className="space-y-3 w-full flex flex-col justify-center items-center">
                      <p className='text-md text-gray-600 text-center'>Uploading files...</p>
                      <div className="flex space-x-3 w-full sm:w-3/4 md:w-2/4 lg:w-2/5">
                        <div className='rounded-xl border-2 border-orange-100 w-full text-center py-2 px-3 flex flex-row justify-center text-3xl items-center space-x-1'>
                          ...
                          {
                            docUpload.type === "application/pdf" ? <BiSolidFilePdf/> : (
                              docUpload.type === "text/plain" ? <BiSolidFileTxt/> : docUpload.type == "image/png" ? <BiSolidFilePng/> : <p></p>
                            )
                          }
                          ...
                          {
                            progress == 100 ? (<></>
                            ) : (<Button color="orange" onClick={uploadDocs} className='flex items-center justify-center'>Upload</Button>)
                          }
                            </div>
                  </div> : 
                  (<></>)
  ...
  
            {
              (allow && display) && (
                ...
                <div className=' w-full flex flex-col justify-center items-center space-y-10 lg:items-end lg:px-5'>
                    ...
                    <Button color="orange" className='w-3/4 text-xs sm:w-2/4 md:w-1/3 lg:w-1/5'  onClick={handleSubmit}> Submit for verification</Button>
                    <Button color="orange" className='w-3/4 text-xs sm:w-2/4 md:w-1/3 lg:w-1/5'>Verify your photo</Button>
                </div>
              )
            }
        </div>
