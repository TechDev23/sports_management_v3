...
const InProgress = () => {
  ...
  return (
    <div className="w-full min-h-full flex flex-col  md:flex-row md:space-x-5">

    
    <div className="md:hidden h-full w-full md:w-1/4 xl:w-1/5  items-center item-center justify-center sticky">
    <Stepper
    ...
    <div className="mt-4 md:mt-0  md:border-none border-t-2 bg-white px-2 h-full w-full md:w-full  flex flex-col items-center justify-between">
